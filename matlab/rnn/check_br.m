function resvec = check_br(itr,tt,A,A_test,Y,Y_test,WZ,L)
...
mse_loss = mean((Y-Z).^2);
mse_val_loss = mean((Y_test-Z_test).^2);
...
resvec = [itr,tt,mse_loss,mse_val_loss,norm_pro];
fprintf('%3d  %6.2f  %4.6f  %4.6f\n',itr,tt,mse_loss,mse_val_loss);
