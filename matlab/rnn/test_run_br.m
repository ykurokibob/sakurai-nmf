...
rng(seed, 'twister');
disp(param)
[WZ,resvec(:,:,seed+1)] = myDeepNN_br_class(X_train,Y_train,X_test,Y_test,param);

%[WZ,resvec(:,:,seed+1)] = myDeepNN_sin_br(X_train,Y_train,X_test,Y_test,param);
